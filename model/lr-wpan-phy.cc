...
LrWpanPhy::EndRx(Ptr<SpectrumSignalParameters> par)
{
    ...
    if (!params)
    {
        NS_LOG_LOGIC("Node: " << m_device->GetAddress() << " Removing interferent.");
    ...
    if (currentRxParams == params)
    {
        ...
        if (!m_currentRxPacket.second)
        {
            ...
            NS_LOG_LOGIC("Packet successfully received");
        ...
        else
        {
            ...
            NS_LOG_LOGIC("Packet destroyed due to interference, post-rx corruption or cancelled");
...
LrWpanPhy::EndTx()
{
    ...
    {
        NS_LOG_LOGIC("Packet successfully transmitted");
    ...
    {
        NS_LOG_LOGIC("Packet transmission aborted");
